...
namespace RedmineClient.Extensions
{
    ...
    internal static partial class XmlExtensions
    {
        ...
        public static int ReadAttributeAsInt(this XmlReader reader, string attributeName)
        {
            ...
            int result;
            if (attribute.IsNullOrWhiteSpace() || !int.TryParse(attribute, NumberStyles.Any, NumberFormatInfo.InvariantInfo, out result))
            {
                return default(int);
            }
        ...
        public static bool ReadAttributeAsBoolean(this XmlReader reader, string attributeName)
        {
            var attribute = reader.GetAttribute(attributeName);
            bool result;
            if (attribute.IsNullOrWhiteSpace() || !bool.TryParse(attribute, out result))
            {
                return false;
            }
        ...
        public static float? ReadElementContentAsNullableFloat(this XmlReader reader)
        {
            var content = reader.ReadElementContentAsString();
            float result;
            if (content.IsNullOrWhiteSpace() || !float.TryParse(content, NumberStyles.Any, NumberFormatInfo.InvariantInfo, out result))
            {
                return null;
            }
        ...
        public static int? ReadElementContentAsNullableInt(this XmlReader reader)
        {
            var content = reader.ReadElementContentAsString();
            int result;
            if (content.IsNullOrWhiteSpace() || !int.TryParse(content, NumberStyles.Any, NumberFormatInfo.InvariantInfo, out result))
            {
                return null;
            }
        ...
        public static decimal? ReadElementContentAsNullableDecimal(this XmlReader reader)
        {
            var content = reader.ReadElementContentAsString();
            decimal result;
            if (content.IsNullOrWhiteSpace() || !decimal.TryParse(content, NumberStyles.Any, NumberFormatInfo.InvariantInfo, out result))
            {
                return null;
            }
